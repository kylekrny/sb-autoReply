...
export default function Hero() {
  ...
  return (
    <div className='bg-gray-800 w-full h-full'>
      ...
      <div className='relative isolate overflow-hidden pt-14 w-full h-full'>
        <svg
          aria-hidden='true'
        ...
        <div className='mx-auto max-w-7xl px-6 lg:px-8 h-full'>
          <div className='mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 h-full flex flex-col justify-center'>
